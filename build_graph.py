...
overall_graph = (graph_helper_functions.FakeNewsDataset
                ...
                ource_username_mapping_dict_path=args.source_username_mapping_dict_path,
                building_original_graph_first=args.building_original_graph_first,
                path_where_data_is=args.path_where_data_is,
                user_id_to_representation_file=args.user_id_to_representation_file,
                source_name_to_representation_file=args.source_name_to_representation_file,
                article_to_representation_file=args.article_to_representation_file,
                articles_per_directory_path=args.articles_per_directory_path,
                article_user_mapping_path=args.article_user_mapping_path,
                article_name_to_id_file=args.article_name_to_id_file))
